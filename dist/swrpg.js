(function () {
  ...
  /* Sender of chat messages */
  const speakingAs$3 = "Weaponsmith Droid";
  ...
  /* Sender of chat messages */
  const speakingAs$4 = "Trade Representative";
  ...
  const setMode = (m) => {
      currentMode = m;
      ModeToModule[m] ? ModeToModule[m].display() : display$8();
  };
  ...
  /* Sender of chat messages */
  const speakingAs$6 = "Repair Droid";
